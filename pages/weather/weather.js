...
Page({
  ...
  getCity:function(latitude,longitude){
    var that = this;
    var url ="https://api.map.baidu.com/geocode/v2/";
    var params = {
  ...
  getWeather:function(city){
    ...
    wx.request({
      ...
      success:function(res){
        ...
        var code = res.data.HeWeather6[0].now.con_code;
        var dir = res.data.HeWeather6[0].now.wind_dir;
        var sc = res.data.HeWeather6[0].now.wind_sc;
        var hum = res.data.HeWeather6[0].now.hum;
        var f1 = res.data.HeWeather6[0].now.f1;
        var daily_forecast = res.data.HeWeather6[0].now.daily_forecast;
        that.setData({
          tmp:tmp,
          txt:txt,
          code:code,
